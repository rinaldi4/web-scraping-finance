...
#     
#    master_list=[]
#    first_row = column_1[0].findChildren(recursive = False)[0].get_text()
#    title_list = []
#    title_list.append(first_row)
#    master_list.append(title_list)
#     
#    data = []
#    for column in column_1:
#        if column.attrs['class'][0] == 'r_content':
#            data.append(column)
#        else:
#            pass
#     
...
#            title_list = []
#            try:
#                if str(row.get_text())== '\xa0':
#                    continue
#                elif str(row.get_text()) == '':
#                    continue
#            except:
#                pass
#            try:
